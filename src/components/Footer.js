                    ...
                    <div className="row g-3">
                        ...
                        <div className="col-lg-2 col-md-5">
                            <div className="d-flex flex-column text-start footer-item">
                                ...
                                <Link to="/pooja-store" className="btn-link">{t('mypooja_store')} </Link>
                                {/*<Link to="/auction" className="btn-link">{t('auction')} </Link>*/}
                        ...
                        <div className="footer-item">
                            ...
                            <p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-geo-alt" viewBox="0 0 16 16">
                                ...
                                </svg> Plot no 5, Sec -2A PNB Road, Vaishali Ghaziabad UP 201010</p>
                            <p>&#x2709; info@thesatim.com</p>
                            <p>&#x260E; +91 70425 55040</p>
                        </div>
                    </div>
                    </div>
